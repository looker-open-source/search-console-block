...
- dashboard: insights
  ...
  description: ''
  preferred_slug: mpSUTmN2lRJToouWli1LJT
  elements:
  - title: Impressions
    name: Impressions
    ...
    note_display: hover
    note_text: How many times your site appeared in Google Search results for users
      during the selected period, even if they didn't click. The percentage indicates
  ...
  - title: Top
    ...
    note_display: hover
    note_text: |-
      How different search terms (queries) that led to your site performed during the selected period:
  ...
  - title: Trending Up
    ...
    note_state: collapsed
    note_display: hover
    note_text: 'Trending up: Queries that gained the most clicks compared to the previous
      period.
  ...
  - title: Top
    ...
    minimum_column_width: 75
    series_labels:
      searchdata_site_impression.clicks_string: Clicks
    series_cell_visualizations:
  ...
  - title: Traffic Sources
    ...
    note_state: collapsed
    note_display: hover
    note_text: Clicks your site received from sources other than Google's Web Search
      results. This could include Image search, Video search, Discover, and Google
      News.
    listen:
      Date: searchdata_site_impression.date_filter
    row: 52
  ...
  - title: Clicks
    ...
    note_state: collapsed
    note_display: hover
    note_text: How many times users clicked your site in Google Search results during
      the selected period. The percentage indicates the change in total clicks compared
